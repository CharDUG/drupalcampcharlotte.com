            ...
            <div id="header-site-info" class="header-site-info block">
              <div id="header-site-info-inner" class="header-site-info-inner inner">
                ...
                <div id="site-name-wrapper" class="clearfix">
                  <?php if ($site_name): ?>
                  <span id="site-name"><a href="<?php print check_url($front_page); ?>" title="<?php print t('Home'); ?>"><img src="<?php print $base_path . path_to_theme(); ?>/images/site-title.png" alt="<?php print $site_name; ?>" /></a></span>
                  <?php endif; ?>
                  <?php if ($site_slogan): ?>
